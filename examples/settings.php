...
/**
 * IMPORTANT NOTE: Please do not change this file.
 * Instead, please copy settings.local.php.example file into your settings.local.php
 * and change the database credentials and other settings there.
 */
